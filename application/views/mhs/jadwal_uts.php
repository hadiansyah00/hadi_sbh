...
<div class="container">
	...
	<!--<a href="<?php echo base_url('mhs/Transkrip/printUTS_karyawan/' . $mhs['id_mahasiswa']); ?>" target="_blank" class="btn btn-sm btn-success"><i class="icofont-print"></i> Print UTS kar</a>-->
