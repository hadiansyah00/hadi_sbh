				...
				<ul>
				    ...
				    <li>
						...
						if ($mhs['status_uts'] == 0) { ?>
							<a href="<?php echo base_url('mhs/Ver_bauk') ?>"><i class="bx bx-file-blank"></i> <span>Jadwal UTS</span></a>
						<?php } else { ?>
							<a href="<?php echo base_url('mhs/jadwaluts_karyawan'); ?>"><i class="bx bx-file"></i> <span>Jadwal UTS</span></a>
						<?php } ?>
					...
					<li><?php
						...
						<?php } else { ?>
							<a href="<?php echo base_url('mhs/transkrip'); ?>"><i class="bx bx-file"></i> <span> Transkrip Nilai </span></a>
						<?php } ?>
					</li>
					<!-- <li><a href="<?php echo base_url('mhs/transkrip'); ?>"><i class="bx bx-edit"></i> Transkrip Nilai</a></li> -->
					<!--<li><a href="<?php echo base_url('mhs/rpsmhs'); ?>"><i class="bx bx-file"></i> RPS Mahasiswa</a></li>-->
